...
create policy "Enable all access" on products for all using (true) with check (true);`;
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4">
        <div className="max-w-3xl w-full space-y-10">
          <div className="text-center space-y-3">
             <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">Are you a Buyer or a Seller?</h2>
             <p className="text-gray-500 text-lg">Select your account type below to continue to the marketplace.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            <button 
              onClick={() => handleRoleSelect(UserRole.BUYER)}
              className="group relative bg-white p-10 rounded-2xl shadow-sm hover:shadow-2xl border border-gray-100 hover:border-blue-200 transition-all duration-300 flex flex-col items-center text-center transform hover:-translate-y-1"
            >
              <div className="bg-blue-50 p-6 rounded-full mb-6 group-hover:bg-blue-600 transition-colors duration-300">
                <ShoppingBag className="w-12 h-12 text-blue-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">I am a Buyer</h3>
              <p className="text-gray-500 leading-relaxed">Browse the latest products, find great deals, and contact sellers directly via WhatsApp.</p>
            </button>

            <button 
              onClick={() => handleRoleSelect(UserRole.SELLER)}
              className="group relative bg-white p-10 rounded-2xl shadow-sm hover:shadow-2xl border border-gray-100 hover:border-purple-200 transition-all duration-300 flex flex-col items-center text-center transform hover:-translate-y-1"
            >
              <div className="bg-purple-50 p-6 rounded-full mb-6 group-hover:bg-purple-600 transition-colors duration-300">
                <Store className="w-12 h-12 text-purple-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">I am a Seller</h3>
              <p className="text-gray-500 leading-relaxed">List your products for free, manage your inventory, and reach thousands of customers.</p>
            </button>
          </div>
          
          <div className="flex justify-center mt-8">
            <button onClick={handleLogout} className="text-gray-400 hover:text-gray-700 flex items-center space-x-2 font-medium transition-colors">
              <LogOut size={18} />
              <span>Sign out</span>
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col relative">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-8 flex-grow">
      ...
      <footer className="bg-white border-t border-gray-200 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <div className="mb-4 md:mb-0 flex items-center space-x-2">
            ...
            <span className="font-semibold text-gray-700">Smart Market</span>
          </div>
          ...
          <div className="mt-4 md:mt-0">
            &copy; {new Date().getFullYear()} Smart Market Inc.
          </div>
        </div>
      </footer>
    </div>
